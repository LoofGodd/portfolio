...
export default function BackgroundCard() {
  return (
    <Card
      id="background"
      className="md:h-full text-white/60"
      title="MY Background"
    >
      <p>
        My initial year was 2020 at RUPP which was a covid event.{" "}
        <span className="underline text-white">First-year</span>, completely on
        virtual class, It was hard to adapt my self into this situation but this
        made my researching skill a bit to another level.{" "}
      </p>
      <p>
        ...
        I also passed a scholarship{" "}
        <span className="text-white font-semibold">
          Coding & Programming using Python
        </span>{" "}
        offered Samsung at RUPP
      </p>
      <p>
        <span className="text-white underline">Third-year,</span> Again! Virtual
        Class!. During the situation I thought learning to program a website was
        large. There are many resources online I could learn for free. I started
        making my self used to the situation and I kinda enjoy😇.
      </p>
      <p>
        <span className="text-white underline">Last year,</span> Happy
        completely physical class🫡. I did a lot this years,
        <span className="text-white">
          Thanks to teacher{" "}
